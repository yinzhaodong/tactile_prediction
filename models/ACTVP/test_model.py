...
model_path      = "/home/user/Robotics/tactile_prediction/tactile_prediction/models/ACTVP/saved_models/TP_single_object_model_17_11_2021_16_32/ACPixelMotionNet_model"
data_save_path  = "/home/user/Robotics/tactile_prediction/tactile_prediction/models/ACTVP/saved_models/TP_single_object_model_17_11_2021_16_32/"
    ...
    def __init__(self):
                ...
                for i in range(16):
                    ...
                    line_4 = ax2.plot([None for i in range(10)] + [abs(pred - gt) for(gt, pred) in
                                                                     zip(groundtruth_taxle[10:],
                                                                          predicted_taxel_t10[:-10])], alpha=1.0, c="k",
                                       label="MAE")
        ...
        def calc_test_performance(self):
            ...
            performance_data_full.append(["test loss MAE(L1) Seen objects: ",(
                        sum([i[0] for i in self.performance_data if i[-1] == '1']) / len(
                    [i[0] for i in self.performance_data if i[-1] == '1']))])
            performance_data_full.append(["test loss MAE(L1) Novel objects: ",(
                        sum([i[0] for i in self.performance_data if i[-1] == '0']) / len(
                    [i[0] for i in self.performance_data if i[-1] == '0']))])
            ...
            performance_data_full.append(["test loss SSIM Seen objects: ",(
                        sum([i[7] for i in self.performance_data if i[-1] == '1']) / len(
                    [i[7] for i in self.performance_data if i[-1] == '1']))])
            performance_data_full.append(["test loss SSIM Novel objects: ",(
                        sum([i[7] for i in self.performance_data if i[-1] == '0']) / len(
                    [i[7] for i in self.performance_data if i[-1] == '0']))])
            ...
            performance_data_full.append(["test loss PSNR Seen objects: ",(
                        sum([i[14] for i in self.performance_data if i[-1] == '1']) / len(
                    [i[14] for i in self.performance_data if i[-1] == '1']))])
            performance_data_full.append(["test loss PSNR Novel objects: ",(
                        sum([i[14] for i in self.performance_data if i[-1] == '0']) / len(
                    [i[14] for i in self.performance_data if i[-1] == '0']))])
