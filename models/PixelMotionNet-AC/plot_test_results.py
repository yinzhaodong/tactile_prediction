...
data_save_path  = "/home/user/Robotics/tactile_prediction/tactile_prediction/models/PixelMotionNet-AC/saved_models/TP_single_object_model_18_11_2021_12_25/"
...
def create_test_plots(experiment_to_test):
    ...
    trial_predicted_data_t5 = np.load(data_save_path + "test_plots_" + str(test_trial) + "/trial_predicted_data_t5.npy")
    trial_predicted_data_t10 = np.load(data_save_path + "test_plots_" + str(test_trial) + "/trial_predicted_data_t10.npy")
