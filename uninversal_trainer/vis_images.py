...
train_out_dir  = dataset_path + 'RSS_VIDEO_train_linear_qual_dataset_10c_10h_universal/'
test_out_dir   = dataset_path + 'RSS_VIDEO_test_linear_qual_dataset_10c_10h_universal/'
scaler_out_dir = dataset_path + 'RSS_VIDEO_scalar_info_universal/'
