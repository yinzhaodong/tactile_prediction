...
if __name__  == "__main__":
	...
	# save the scalars
	dump (tactile_standard_scaler[0], open (out_dir + 'tactile_standard_scaler_x.pkl', 'wb'))
	dump (tactile_standard_scaler[1], open (out_dir + 'tactile_standard_scaler_y.pkl', 'wb'))
	dump (tactile_standard_scaler[2], open (out_dir + 'tactile_standard_scaler_z.pkl', 'wb'))
	dump (tactile_min_max_scalar[0], open (out_dir + 'tactile_min_max_scalar_x.pkl', 'wb'))
	dump (tactile_min_max_scalar[1], open (out_dir + 'tactile_min_max_scalar_y.pkl', 'wb'))
	dump (tactile_min_max_scalar[2], open (out_dir + 'tactile_min_max_scalar.pkl', 'wb'))

	dump (robot_min_max_scalar[0], open (out_dir + 'robot_min_max_scalar_px.pkl', 'wb'))
	dump (robot_min_max_scalar[1], open (out_dir + 'robot_min_max_scalar_py.pkl', 'wb'))
	dump (robot_min_max_scalar[2], open (out_dir + 'robot_min_max_scalar_pz.pkl', 'wb'))
	dump (robot_min_max_scalar[3], open (out_dir + 'robot_min_max_scalar_ex.pkl', 'wb'))
	dump (robot_min_max_scalar[4], open (out_dir + 'robot_min_max_scalar_ey.pkl', 'wb'))
	dump (robot_min_max_scalar[5], open (out_dir + 'robot_min_max_scalar_ez.pkl', 'wb'))
	...
	for experiment_number in tqdm(range(len(files))):
		...
		for sample in range(0, tactile_data.shape[0] - sequence_length):
			...
			np.save(out_dir + 'tactile_data_sequence_' + str(index_to_save), tactile_data_sequence)
			np.save(out_dir + 'tactile_image_name_sequence_' + str(index_to_save), tactile_image_name_sequence)
